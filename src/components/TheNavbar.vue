...
<template>
  <nav
    class="z-50 duration-300"
    :class="{ 'fixed  top-0 left-0 right-0 bg-primary': shouldShowBackground }"
  >
    <nav
      class="max-w-6xl pt-10 mx-auto duration-300 navbar"
      :class="{ 'pt-2': shouldShowBackground }"
    >
      ...
      <div class="flex navbar-end md:hidden">
        <div class="z-20">
          ...
          <div class="drawer-side">
            ...
            ></label>
            <div
              class="flex items-center min-h-full gap-6 p-4 pt-20 text-lg menu w-80 bg-base-200 text-primary"
            >
